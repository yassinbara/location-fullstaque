...
import { createCar, getCarByid, updateCare } from '../../redux/api/car'
...
const Update = () => {
    ...
    const { errorValidation, car } = useSelector(state => state.car)
    ...
    const handelSubmit = e => {
        e.preventDefault()
        dispatch(updateCare(id,formData, () => navigate(-1)))
    }
    useEffect(() => {
